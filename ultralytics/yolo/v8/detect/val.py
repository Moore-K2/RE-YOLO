...
def val(cfg=DEFAULT_CFG, use_python=True):
    ...
    model = detect / 'dota_v1_5cls_20240716/yolov8_renet_ori_bifpn_s_1024/weights/best.pt'
    data = 'dota_v1_5cls.yaml'
    # model = cfg.model or 'yolov8n.pt'
    # data = cfg.data or 'coco128.yaml'
    name = 'val_' + 'yolov8_renet_ori_bifpn_s_1024'
    imgsz = 1024
    device = '0'
    args = dict(model=model, data=data, name=name, imgsz=imgsz, device=device)
    if use_python:
